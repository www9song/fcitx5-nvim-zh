...
autocmd InsertLeave * :silent let fcitx5state=system("fcitx5-remote")[0] | call system("fcitx5-remote -c") " Disable the input method when exiting insert mode and save the state
